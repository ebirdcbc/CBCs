...
-   Practice by eBirding in your favorite patch or better yet in your assigned area during [count-week](https://www.audubon.org/conservation/science/christmas-bird-count/christmas-bird-count-compiler-resources#:~:text=Count%20week%20is%20defined%20as,Dec%2014%2DJan%205) the 3 days before or after your CBC if possible.
...
[![Northern Harrier flying past at Tennessee Valley CBC, © D. Kapan 2017](images/esc6382.jpeg)](images/esc6382.jpeg)
...
-   **Upload and Share**: Upload and share your eBird lists with your area leader’s eBird persona (the eBird username that the area leader uses to aggregate all the day's lists e.g. **abbottslagoon**) via the share function in the app or web. If corrections are needed, update the list and RESHARE back to their eBird persona.
...
-   Create a new eBird list for each location your leader suggests, like unique habitats in your route or polygon, with tracks enabled. This forms the basis for bird observations and CBC effort data.
