...
\- Encourage more people to join Christmas Bird Counts (CBCs) by bridging the gap between eBirders, immersed in the digitally enabled tradition of eBirding, and the Christmas Bird Count community, who primarily use analog methods in this long-standing community science project.  
...
\- Dr. Durrell D. Kapan: Senior Research Fellow, California Academy of Sciences.  Concept, model, MAX-SUM algorithm, iteration lead as area leader on two CBC counts.

\- Mark Schulist: eBirdCBC primary developer, programming expert, website designer, and protocol iteration with extensive participation in CBC activities.

\- This project also relies on the efforts of countless volunteers and bird enthusiasts who contribute to the success of CBCs across the region.
